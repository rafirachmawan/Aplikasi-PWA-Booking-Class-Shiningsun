...
export function BackButtonHandler() {
  ...
  useEffect(() => {
    // Push a state entry to intercept hardware/browser back button
    try {
      window.history.pushState({ trapped: true, path: pathname }, "", window.location.href);
    } catch (e) {
    ...
    const handlePopState = (e: PopStateEvent) => {
      ...
      if (pathname !== "/dashboard") {
        ...
        try {
          window.history.pushState({ trapped: true, path: "/dashboard" }, "", "/dashboard");
        } catch (err) {}
