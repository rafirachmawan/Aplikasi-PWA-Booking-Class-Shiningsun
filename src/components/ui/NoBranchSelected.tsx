...
export function NoBranchSelected({ pageName = "halaman ini" }: NoBranchSelectedProps) {
      ...
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="rounded-3xl bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 border-2 border-dashed border-slate-300 dark:border-slate-700 p-8 sm:p-16 flex flex-col items-center justify-center text-center min-h-[50vh]">
          ...
          <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 max-w-md leading-relaxed mb-6">
            Untuk mengakses <span className="font-semibold text-slate-700 dark:text-slate-300">{pageName}</span>, silakan pilih cabang terlebih dahulu melalui Dashboard.
          </p>
          ...
          >
            ...
            {isNavigating ? "Menuju Dashboard..." : "Ke Dashboard & Pilih Cabang"}
          </button>
        </div>
      </div>
    </>
