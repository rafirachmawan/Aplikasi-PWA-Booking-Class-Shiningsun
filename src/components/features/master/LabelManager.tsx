...
const PREDEFINED_COLORS = [
  // Merah (Red)
  { name: "Merah 50", hex: "#fef2f2" },
  { name: "Merah 100", hex: "#fee2e2" },
  { name: "Merah 200", hex: "#fecaca" },
  { name: "Merah 300", hex: "#fca5a5" },
  { name: "Merah 400", hex: "#f87171" },
  { name: "Merah 500", hex: "#ef4444" },
  { name: "Merah 600", hex: "#dc2626" },
  { name: "Merah 700", hex: "#b91c1c" },
  { name: "Merah 800", hex: "#991b1b" },
  { name: "Merah 900", hex: "#7f1d1d" },
  { name: "Merah 950", hex: "#450a0a" },
  // Rose
  ...
  // Ungu (Purple)
  { name: "Ungu 50", hex: "#faf5ff" },
  { name: "Ungu 100", hex: "#f3e8ff" },
  { name: "Ungu 200", hex: "#e9d5ff" },
  { name: "Ungu 300", hex: "#d8b4fe" },
  { name: "Ungu 400", hex: "#c084fc" },
  { name: "Ungu 500", hex: "#a855f7" },
  { name: "Ungu 600", hex: "#9333ea" },
  { name: "Ungu 700", hex: "#7e22ce" },
  { name: "Ungu 800", hex: "#6b21a8" },
  { name: "Ungu 900", hex: "#581c87" },
  { name: "Ungu 950", hex: "#3b0764" },
  // Violet
  ...
  // Nila (Indigo)
  { name: "Nila 50", hex: "#eef2ff" },
  { name: "Nila 100", hex: "#e0e7ff" },
  { name: "Nila 200", hex: "#c7d2fe" },
  { name: "Nila 300", hex: "#a5b4fc" },
  { name: "Nila 400", hex: "#818cf8" },
  { name: "Nila 500", hex: "#6366f1" },
  { name: "Nila 600", hex: "#4f46e5" },
  { name: "Nila 700", hex: "#4338ca" },
  { name: "Nila 800", hex: "#3730a3" },
  { name: "Nila 900", hex: "#312e81" },
  { name: "Nila 950", hex: "#1e1b4b" },
  // Biru (Blue)
  { name: "Biru 50", hex: "#eff6ff" },
  { name: "Biru 100", hex: "#dbeafe" },
  { name: "Biru 200", hex: "#bfdbfe" },
  { name: "Biru 300", hex: "#93c5fd" },
  { name: "Biru 400", hex: "#60a5fa" },
  { name: "Biru 500", hex: "#3b82f6" },
  { name: "Biru 600", hex: "#2563eb" },
  { name: "Biru 700", hex: "#1d4ed8" },
  { name: "Biru 800", hex: "#1e40af" },
  { name: "Biru 900", hex: "#1e3a8a" },
  { name: "Biru 950", hex: "#172554" },
  // Sky
  ...
  // Zamrud (Emerald)
  { name: "Zamrud 50", hex: "#ecfdf5" },
  { name: "Zamrud 100", hex: "#d1fae5" },
  { name: "Zamrud 200", hex: "#a7f3d0" },
  { name: "Zamrud 300", hex: "#6ee7b7" },
  { name: "Zamrud 400", hex: "#34d399" },
  { name: "Zamrud 500", hex: "#10b981" },
  { name: "Zamrud 600", hex: "#059669" },
  { name: "Zamrud 700", hex: "#047857" },
  { name: "Zamrud 800", hex: "#065f46" },
  { name: "Zamrud 900", hex: "#064e3b" },
  { name: "Zamrud 950", hex: "#022c22" },
  // Hijau (Green)
  { name: "Hijau 50", hex: "#f0fdf4" },
  { name: "Hijau 100", hex: "#dcfce7" },
  { name: "Hijau 200", hex: "#bbf7d0" },
  { name: "Hijau 300", hex: "#86efac" },
  { name: "Hijau 400", hex: "#4ade80" },
  { name: "Hijau 500", hex: "#22c55e" },
  { name: "Hijau 600", hex: "#16a34a" },
  { name: "Hijau 700", hex: "#15803d" },
  { name: "Hijau 800", hex: "#166534" },
  { name: "Hijau 900", hex: "#14532d" },
  { name: "Hijau 950", hex: "#052e16" },
  // Lime
  ...
  // Kuning (Yellow)
  { name: "Kuning 50", hex: "#fefce8" },
  { name: "Kuning 100", hex: "#fef9c3" },
  { name: "Kuning 200", hex: "#fef08a" },
  { name: "Kuning 300", hex: "#fde047" },
  { name: "Kuning 400", hex: "#facc15" },
  { name: "Kuning 500", hex: "#eab308" },
  { name: "Kuning 600", hex: "#ca8a04" },
  { name: "Kuning 700", hex: "#a16207" },
  { name: "Kuning 800", hex: "#854d0e" },
  { name: "Kuning 900", hex: "#713f12" },
  { name: "Kuning 950", hex: "#422006" },
  // Amber
  ...
  // Oranye (Orange)
  { name: "Oranye 50", hex: "#fff7ed" },
  { name: "Oranye 100", hex: "#ffedd5" },
  { name: "Oranye 200", hex: "#fed7aa" },
  { name: "Oranye 300", hex: "#fdba74" },
  { name: "Oranye 400", hex: "#fb923c" },
  { name: "Oranye 500", hex: "#f97316" },
  { name: "Oranye 600", hex: "#ea580c" },
  { name: "Oranye 700", hex: "#c2410c" },
  { name: "Oranye 800", hex: "#9a3412" },
  { name: "Oranye 900", hex: "#7c2d12" },
  { name: "Oranye 950", hex: "#431407" },
    ...
    <div className="bg-white dark:bg-slate-900 shadow-sm ring-1 ring-slate-900/5 sm:rounded-xl overflow-hidden">
        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 w-full max-w-sm bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 p-6 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 text-center mt-2 leading-relaxed">
              ...
              ? Label yang masih digunakan oleh siswa tidak dapat dihapus.
            </p>
      ...
      <div className="px-4 py-5 sm:px-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Atur label warna untuk pengelompokan siswa.
          </p>
        </div>
        {!isAdding && (
          <button
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start">
                  ...
                  {PREDEFINED_COLORS.map((c) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full shadow-sm transition-transform hover:scale-110 focus:outline-none ${
                        color === c.hex
                          ? "ring-4 ring-offset-2 ring-brand-500 dark:ring-offset-slate-900 scale-110"
                ...
                <div className="flex-1 flex flex-col items-center justify-center space-y-4 p-6 border border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-900 w-full sm:w-auto">
                  ...
                  <div className="text-xs text-slate-400 font-mono uppercase bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded">
                    {color}
                  </div>
                </div>
              </div>
      ...
      >
        {labels.map((label) => (
          <li
            key={label.id}
            className="flex items-center justify-between gap-x-6 px-4 py-5 sm:px-6 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
          >
            <div className="flex min-w-0 gap-x-4 items-center">
              <div
                className="h-10 w-10 flex-none rounded-full shadow-sm ring-1 ring-black/10 dark:ring-white/10"
