    ...
    <div className="flex min-h-screen bg-slate-900 overflow-x-hidden font-sans">
      ...
      <div className="hidden lg:flex lg:w-[50%] xl:w-[55%] relative flex-col justify-between p-12 overflow-hidden bg-[#0A0F1C] border-r border-slate-800/50">
        ...
        <div className="absolute inset-0 w-full h-full">
          <div
            className="absolute -top-1/4 -left-1/4 w-[85%] h-[85%] rounded-full bg-brand-600/35 blur-[120px] mix-blend-screen animate-pulse"
            style={{ animationDuration: "8s" }}
          />
          <div
            className="absolute top-1/3 -right-1/4 w-[75%] h-[75%] rounded-full bg-blue-500/25 blur-[100px] mix-blend-screen animate-pulse"
            style={{ animationDuration: "12s" }}
          />
          <div
            className="absolute -bottom-1/4 left-1/4 w-[90%] h-[90%] rounded-full bg-indigo-500/25 blur-[130px] mix-blend-screen animate-pulse"
