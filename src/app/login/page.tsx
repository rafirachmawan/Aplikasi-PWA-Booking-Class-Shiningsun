    ...
    <div className="min-h-screen bg-[#0A0F1C] flex flex-col lg:flex-row overflow-x-hidden font-sans">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative flex-col justify-between p-12 overflow-hidden bg-[#0A0F1C]">
        ...
        <div className="absolute inset-0 w-full h-full">
          <div
            className="absolute -top-1/4 -left-1/4 w-[80%] h-[80%] rounded-full bg-brand-600/30 blur-[120px] mix-blend-screen animate-pulse"
            style={{ animationDuration: "8s" }}
          />
          <div
            className="absolute top-1/4 -right-1/4 w-[70%] h-[70%] rounded-full bg-blue-500/20 blur-[100px] mix-blend-screen animate-pulse"
            style={{ animationDuration: "12s" }}
          />
          <div
            className="absolute -bottom-1/4 left-1/4 w-[90%] h-[90%] rounded-full bg-indigo-500/20 blur-[130px] mix-blend-screen animate-pulse"
      ...
      <div className="flex-1 flex flex-col justify-center min-h-screen lg:min-h-0 px-3 py-4 sm:px-8 sm:py-8 lg:px-20 bg-[#0A0F1C] lg:bg-white lg:dark:bg-[#0B1120] relative z-10 lg:rounded-l-[40px] shadow-[-20px_0_40px_-15px_rgba(0,0,0,0.3)] overflow-hidden">
        ...
        <div className="w-full max-w-95 mx-auto my-auto py-2 sm:py-0">
          ...
          <div className="flex flex-col items-center mb-5 sm:mb-6 lg:hidden text-center">
            ...
            <p className="mt-1 text-slate-200 text-xs sm:text-sm font-medium">
              Cerdas, Ceria, Kreatif dan Mandiri
            </p>
          </div>
          ...
          <noscript>
            <div className="mt-3 p-2.5 bg-amber-500/10 border border-amber-500/30 rounded-xl text-center">
              ...
              <a
                href="/login-basic"
                className="text-xs text-amber-700 font-extrabold underline"
              >
          ...
          <div className="text-center mt-3 mb-1">
            <a
              href="/login-basic"
              className="text-[11px] text-slate-400 hover:text-slate-300 underline transition-colors"
            >
